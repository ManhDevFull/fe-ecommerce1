...
export default function Product({
    ...
    isNew }: productProps) {
    return (
        <div className="w-auto p-2 bg-gray-100 h-auto flex justify-center items-center rounded-3xl">
            <div className=" bg-gray-200 rounded-3xl p-6 sm:p-14 lg:p-10 relative">
