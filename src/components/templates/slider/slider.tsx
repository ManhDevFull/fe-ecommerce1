...
export function Slider() {
    ...
    return (
        <div className=" w-full px-4 sm:px-16">
            <div className="w-full border-none h-[200px] sm:h-[250px] lg:h-[350px] rounded-2xl bg-blue-500 z-0 relative">
                <div className="w-full relative h-full overflow-hidden">
                    <div className="absolute z-0 -right-8 bottom-34 flex justify-center items-center w-120 h-120 rounded-full border-[1px] border-white ">
                        <div className="w-110 h-110 rounded-full bg-yellow-500">
                        </div>
                    </div>
                    <div className="absolute right-56 top-60 flex items-center justify-center w-44 h-44 rounded-full border-[1px] border-white">
                        <div className="w-36 h-36 rounded-full bg-yellow-500">
                        </div>
                    </div>
                </div>
                                ...
                                <div key={index} className="flex items-center w-full shrink-0">
                                    <div className="w-full flex justify-between items-center">
                                        <div className="px-10 md:pt-10 lg:pt-0 lg:px-20 pt-2">
                                            <h5 className="sm:text-xl lg:text-3xl text-white">{slide.title}</h5>
                                            <h1 className="sm:text-2xl lg:text-4xl xl:text-5xl py-2 sm:py-8 font-medium text-white">{slide.product}</h1>
                ...
                <div className="w-full absolute z-40 top-[30%]">
                    <div className="flex justify-between">
                        <div onClick={prevSlide} className="flex justify-center items-center p-4 hover:cursor-pointer rounded-full -translate-x-1/2 bg-white">
                            <div className="lg:w-[50px] lg:h-[50px] xl:w-[80px] xl:h-[80px] rounded-full bg-blue-50 flex justify-center items-center">
